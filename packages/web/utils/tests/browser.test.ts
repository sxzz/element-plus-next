...
import { isClient as vueuseIsClient } from '@vueuse/shared'
...
describe('browser', () => {
  ...
  it('isClient should be re-export by vueuse', () => {
    expect(isClient).toBe(vueuseIsClient)
  })

  it('isServer should always be the opposite of isClient', () => {
